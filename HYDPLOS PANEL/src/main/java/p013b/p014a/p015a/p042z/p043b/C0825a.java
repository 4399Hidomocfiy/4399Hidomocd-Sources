...
import android.support.p009v4.app.FrameMetricsAggregator;
...
public final class C0825a {
    ...
    /* renamed from: a */
    public byte[] mo8924a() {
        byte[] bArr = new byte[Constants.D2F];
        int g = this.f1704a.mo8795g();
        int j = this.f1704a.mo8799j();
        for (int i = 0; i < g; i++) {
            int[] iArr = f1703b[i];
            for (int i2 = 0; i2 < j; i2++) {
                int i3 = iArr[i2];
                if (i3 >= 0 && this.f1704a.mo8791d(i2, i)) {
                    int i4 = i3 / 6;
