...
public class ClassManagerImpl extends BshClassManager {
    ...
    public Class classForName(String str) {
        ...
        if (this.absoluteNonClasses.get(str) == null) {
            if (Interpreter.DEBUG) {
                StringBuffer stringBuffer = new StringBuffer();
                stringBuffer.append("Trying to load class: ");
            ...
            stringBuffer2.append("absoluteNonClass list hit: ");
    ...
    public void reloadClasses(String[] strArr) {
        ...
        for (String str : strArr) {
            ...
            } else if (!(classSource instanceof BshClassPath.JarClassSource)) {
        ...
        for (String str2 : classSourceMap.keySet()) {
            this.loaderMap.put(str2, discreteFilesClassLoader);
        }
        classLoaderChanged();
    }
