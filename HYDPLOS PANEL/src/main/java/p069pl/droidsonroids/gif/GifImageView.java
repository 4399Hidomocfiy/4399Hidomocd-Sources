...
public class GifImageView extends ImageView {
    ...
    public GifImageView(Context context, AttributeSet attributeSet) {
        ...
        m4114a(C1495f.m4186c(this, attributeSet, 0, 0));
    }

    public GifImageView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        m4114a(C1495f.m4186c(this, attributeSet, i, 0));
    }

    /* renamed from: a */
    private void m4114a(C1495f.C1496a aVar) {
        this.f3613a = aVar.f3683a;
        int i = aVar.f3681c;
        if (i > 0) {
    ...
    public Parcelable onSaveInstanceState() {
        ...
        Drawable drawable2 = this.f3613a ? getDrawable() : null;
        if (this.f3613a) {
