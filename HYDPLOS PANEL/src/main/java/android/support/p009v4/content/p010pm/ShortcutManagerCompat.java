...
public class ShortcutManagerCompat {
    ...
    public static boolean isRequestPinShortcutSupported(android.content.Context r4) {
        ...
        L_0x0013:
            ...
            int r1 = android.support.p009v4.content.ContextCompat.checkSelfPermission(r4, r0)
            r2 = 0
        ...
        L_0x004e:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p009v4.content.p010pm.ShortcutManagerCompat.isRequestPinShortcutSupported(android.content.Context):boolean");
    }
    ...
    public static boolean requestPinShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat, final IntentSender intentSender) {
        ...
        context.sendOrderedBroadcast(addToIntent, null, new BroadcastReceiver() {
            /* class android.support.p009v4.content.p010pm.ShortcutManagerCompat.C03101 */
