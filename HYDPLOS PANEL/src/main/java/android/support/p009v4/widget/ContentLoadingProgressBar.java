...
public class ContentLoadingProgressBar extends ProgressBar {
    ...
    public ContentLoadingProgressBar(Context context, AttributeSet attributeSet) {
        ...
        this.mDelayedHide = new Runnable() {
            /* class android.support.p009v4.widget.ContentLoadingProgressBar.RunnableC04201 */
        ...
        this.mDelayedShow = new Runnable() {
            /* class android.support.p009v4.widget.ContentLoadingProgressBar.RunnableC04212 */
