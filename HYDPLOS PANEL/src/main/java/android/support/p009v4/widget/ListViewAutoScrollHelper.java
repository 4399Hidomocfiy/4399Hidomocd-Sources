...
public class ListViewAutoScrollHelper extends AutoScrollHelper {
    ...
    @Override // android.support.p009v4.widget.AutoScrollHelper
    ...
    public boolean canTargetScrollVertically(int r8) {
        ...
        L_0x0039:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p009v4.widget.ListViewAutoScrollHelper.canTargetScrollVertically(int):boolean");
    }
