...
public class ImageViewCompat {
    ...
    static class BaseViewCompatImpl implements ImageViewCompatImpl {
        ...
        @Override // android.support.p009v4.widget.ImageViewCompat.ImageViewCompatImpl
    ...
    static class LollipopViewCompatImpl extends BaseViewCompatImpl {
        ...
        @Override // android.support.p009v4.widget.ImageViewCompat.ImageViewCompatImpl, android.support.p009v4.widget.ImageViewCompat.BaseViewCompatImpl
        public ColorStateList getImageTintList(ImageView imageView) {
