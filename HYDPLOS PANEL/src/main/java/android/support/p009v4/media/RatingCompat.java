...
public final class RatingCompat implements Parcelable {
    public static final Parcelable.Creator<RatingCompat> CREATOR = new Parcelable.Creator<RatingCompat>() {
        /* class android.support.p009v4.media.RatingCompat.C03541 */
    ...
    public Object getRating() {
        ...
        if (this.mRatingObj == null && Build.VERSION.SDK_INT >= 19) {
            if (isRated()) {
                ...
                switch (i) {
                    case 1:
                        obj = RatingCompatKitkat.newHeartRating(hasHeart());
                        break;
                    case 2:
                        obj = RatingCompatKitkat.newThumbRating(isThumbUp());
                        break;
                    case 3:
                    case 4:
                    case 5:
                        obj = RatingCompatKitkat.newStarRating(i, getStarRating());
                        break;
                    case 6:
                        obj = RatingCompatKitkat.newPercentageRating(getPercentRating());
                        break;
                    default:
                        return null;
                }
            } else {
                obj = RatingCompatKitkat.newUnratedRating(this.mRatingStyle);
            }
            this.mRatingObj = obj;
        }
