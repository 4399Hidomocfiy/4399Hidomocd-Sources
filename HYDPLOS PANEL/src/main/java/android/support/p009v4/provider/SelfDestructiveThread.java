...
public class SelfDestructiveThread {
    ...
    private Handler.Callback mCallback = new Handler.Callback() {
        /* class android.support.p009v4.provider.SelfDestructiveThread.C03891 */
    ...
    public <T> void postAndReply(final Callable<T> callable, final ReplyCallback<T> replyCallback) {
        ...
        post(new Runnable() {
            /* class android.support.p009v4.provider.SelfDestructiveThread.RunnableC03902 */
            ...
            public void run() {
                ...
                handler.post(new Runnable() {
                    /* class android.support.p009v4.provider.SelfDestructiveThread.RunnableC03902.RunnableC03911 */
    ...
    public <T> T postAndWait(final Callable<T> callable, int i) {
        ...
        post(new Runnable() {
            /* class android.support.p009v4.provider.SelfDestructiveThread.RunnableC03923 */
