...
public class ResultReceiver implements Parcelable {
    ...
    class MyResultReceiver extends IResultReceiver.Stub {
        ...
        @Override // android.support.p009v4.p011os.IResultReceiver
