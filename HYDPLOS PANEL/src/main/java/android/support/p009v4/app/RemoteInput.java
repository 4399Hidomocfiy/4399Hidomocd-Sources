...
public final class RemoteInput extends RemoteInputCompatBase.RemoteInput {
    ...
    public static final RemoteInputCompatBase.RemoteInput.Factory FACTORY = new RemoteInputCompatBase.RemoteInput.Factory() {
        /* class android.support.p009v4.app.RemoteInput.C03031 */

        @Override // android.support.p009v4.app.RemoteInputCompatBase.RemoteInput.Factory
    ...
    static class ImplApi20 implements Impl {
        ...
        @Override // android.support.p009v4.app.RemoteInput.Impl
    ...
    static {
        ...
        IMPL = i >= 20 ? new ImplApi20() : i >= 16 ? new ImplJellybean() : new ImplBase();
    }
    ...
    @Override // android.support.p009v4.app.RemoteInputCompatBase.RemoteInput
