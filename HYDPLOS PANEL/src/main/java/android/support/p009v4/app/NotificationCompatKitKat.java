...
class NotificationCompatKitKat {
    ...
    public static class Builder implements NotificationBuilderWithBuilderAccessor, NotificationBuilderWithActions {
        ...
        /* renamed from: b */
        private Notification.Builder f1000b;
        ...
        public Builder(Context context, Notification notification, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, RemoteViews remoteViews, int i, PendingIntent pendingIntent, PendingIntent pendingIntent2, Bitmap bitmap, int i2, int i3, boolean z, boolean z2, boolean z3, int i4, CharSequence charSequence4, boolean z4, ArrayList<String> arrayList, Bundle bundle, String str, boolean z5, String str2, RemoteViews remoteViews2, RemoteViews remoteViews3) {
            ...
            this.f1000b = deleteIntent.setFullScreenIntent(pendingIntent3, z6).setLargeIcon(bitmap).setNumber(i).setUsesChronometer(z3).setPriority(i4).setProgress(i2, i3, z);
            ...
            if (str != null) {
                ...
                this.mExtras.putBoolean(z5 ? NotificationCompatExtras.EXTRA_GROUP_SUMMARY : NotificationManagerCompat.EXTRA_USE_SIDE_CHANNEL, true);
            }
            if (str2 != null) {
        ...
        public void addAction(NotificationCompatBase.Action action) {
            this.mActionExtrasList.add(NotificationCompatJellybean.writeActionAndGetExtras(this.f1000b, action));
        }
        ...
        public Notification build() {
            ...
            this.f1000b.setExtras(this.mExtras);
            Notification build = this.f1000b.build();
