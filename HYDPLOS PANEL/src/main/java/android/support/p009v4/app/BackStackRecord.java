...
import android.support.p009v4.app.FragmentManagerImpl;
...
public final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
    ...
    String mName;
    ArrayList<C0272Op> mOps = new ArrayList<>();
    int mPopEnterAnim;
    int mPopExitAnim;
    ...
    public static final class C0272Op {
        int cmd;
        int enterAnim;
        int exitAnim;
        Fragment fragment;
        ...
        C0272Op(int i, Fragment fragment2) {
            this.cmd = i;
    ...
    private void doAddOp(int i, Fragment fragment, String str, int i2) {
        ...
        addOp(new C0272Op(i2, fragment));
    }

    private static boolean isFragmentPostponed(C0272Op op) {
        Fragment fragment = op.fragment;
        return fragment != null && fragment.mAdded && fragment.mView != null && !fragment.mDetached && !fragment.mHidden && fragment.isPostponed();
    }

    @Override // android.support.p009v4.app.FragmentTransaction
            ...
            if (i2 != 1) {
                if (i2 == 2) {
                        ...
                        if (fragment4.mContainerId == i3) {
                            if (fragment4 == fragment3) {
                                ...
                                if (fragment4 == fragment2) {
                                    this.mOps.add(i, new C0272Op(9, fragment4));
                                    i++;
                                    fragment2 = null;
                                }
                                C0272Op op2 = new C0272Op(3, fragment4);
                    ...
                    if (fragment5 == fragment2) {
                        this.mOps.add(i, new C0272Op(9, fragment5));
                        i++;
                        fragment2 = null;
                    }
                } else if (i2 != 7) {
                    if (i2 == 8) {
                        this.mOps.add(i, new C0272Op(9, fragment2));
                        i++;
    ...
    @Override // android.support.p009v4.app.FragmentManager.BackStackEntry
