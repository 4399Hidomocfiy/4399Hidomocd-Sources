...
import android.support.p009v4.app.NotificationCompatApi24;
import android.support.p009v4.app.NotificationCompatApi26;
...
import android.support.p009v4.text.BidiFormatter;
...
import p000a.p004b.p005a.C0008a;
import p000a.p004b.p005a.C0009b;
import p000a.p004b.p005a.C0010c;
import p000a.p004b.p005a.C0011d;
import p000a.p004b.p005a.C0013f;
...
public class NotificationCompat {
    ...
    public static class Action extends NotificationCompatBase.Action {
        public static final NotificationCompatBase.Action.Factory FACTORY = new NotificationCompatBase.Action.Factory() {
            /* class android.support.p009v4.app.NotificationCompat.Action.C03011 */

            @Override // android.support.p009v4.app.NotificationCompatBase.Action.Factory
        ...
        public static final class WearableExtender implements Extender {
            ...
            @Override // android.support.p009v4.app.NotificationCompat.Action.Extender
        ...
        @Override // android.support.p009v4.app.NotificationCompatBase.Action
    ...
    public static class BuilderExtender {
        ...
        public Notification build(Builder builder, NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            Style style3 = builder.mStyle;
            RemoteViews makeContentView = style3 != null ? style3.makeContentView(notificationBuilderWithBuilderAccessor) : null;
            Notification build = notificationBuilderWithBuilderAccessor.build();
            if (!(makeContentView == null && (makeContentView = builder.mContentView) == null)) {
                build.contentView = makeContentView;
            }
            int i = Build.VERSION.SDK_INT;
            if (!(i < 16 || (style2 = builder.mStyle) == null || (makeBigContentView = style2.makeBigContentView(notificationBuilderWithBuilderAccessor)) == null)) {
                build.bigContentView = makeBigContentView;
            }
            if (!(i < 21 || (style = builder.mStyle) == null || (makeHeadsUpContentView = style.makeHeadsUpContentView(notificationBuilderWithBuilderAccessor)) == null)) {
    ...
    public static final class CarExtender implements Extender {
        ...
        public static class UnreadConversation extends NotificationCompatBase.UnreadConversation {
            static final NotificationCompatBase.UnreadConversation.Factory FACTORY = new NotificationCompatBase.UnreadConversation.Factory() {
                /* class android.support.p009v4.app.NotificationCompat.CarExtender.UnreadConversation.C03021 */

                @Override // android.support.p009v4.app.NotificationCompatBase.UnreadConversation.Factory
            ...
            @Override // android.support.p009v4.app.NotificationCompatBase.UnreadConversation
        ...
        @Override // android.support.p009v4.app.NotificationCompat.Extender
        public Builder extend(Builder builder) {
            if (Build.VERSION.SDK_INT < 21) {
                return builder;
            }
            ...
            if (unreadConversation != null) {
                bundle.putBundle(EXTRA_CONVERSATION, NotificationCompat.IMPL.getBundleForUnreadConversation(unreadConversation));
            }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            ...
            boolean z2 = true;
            int i = 0;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0013f.f48c, false);
            applyStandardTemplate.removeAllViews(C0011d.f30e);
            if (!z || (arrayList = this.mBuilder.mActions) == null || (min = Math.min(arrayList.size(), 3)) <= 0) {
                z2 = false;
            } else {
                for (int i2 = 0; i2 < min; i2++) {
                    applyStandardTemplate.addView(C0011d.f30e, generateActionButton(this.mBuilder.mActions.get(i2)));
                }
            }
            if (!z2) {
                i = 8;
            }
            applyStandardTemplate.setViewVisibility(C0011d.f30e, i);
            applyStandardTemplate.setViewVisibility(C0011d.f27b, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z ? C0013f.f47b : C0013f.f46a);
            remoteViews.setImageViewBitmap(C0011d.f28c, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0008a.f12a)));
            remoteViews.setTextViewText(C0011d.f29d, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0011d.f26a, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0011d.f26a, action.title);
            }
            return remoteViews;
        }
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(android.support.p009v4.app.NotificationBuilderWithBuilderAccessor r11) {
            /*
            // Method dump skipped, instructions count: 228
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p009v4.app.NotificationCompat.MessagingStyle.apply(android.support.v4.app.NotificationBuilderWithBuilderAccessor):void");
        }
    ...
    static class NotificationCompatApi16Impl extends NotificationCompatBaseImpl {
        ...
        @Override // android.support.p009v4.app.NotificationCompat.NotificationCompatImpl, android.support.p009v4.app.NotificationCompat.NotificationCompatBaseImpl
    ...
    static class NotificationCompatApi19Impl extends NotificationCompatApi16Impl {
        ...
        @Override // android.support.p009v4.app.NotificationCompat.NotificationCompatApi16Impl, android.support.p009v4.app.NotificationCompat.NotificationCompatImpl, android.support.p009v4.app.NotificationCompat.NotificationCompatBaseImpl
        public Notification build(Builder builder, BuilderExtender builderExtender) {
    ...
    static class NotificationCompatApi20Impl extends NotificationCompatApi19Impl {
        ...
        @Override // android.support.p009v4.app.NotificationCompat.NotificationCompatApi19Impl, android.support.p009v4.app.NotificationCompat.NotificationCompatApi16Impl, android.support.p009v4.app.NotificationCompat.NotificationCompatImpl, android.support.p009v4.app.NotificationCompat.NotificationCompatBaseImpl
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            if (style2 != null) {
                style2.addCompatExtras(NotificationCompat.getExtras(build));
            }
            return build;
        }
    ...
    static class NotificationCompatApi21Impl extends NotificationCompatApi20Impl {
        ...
        @Override // android.support.p009v4.app.NotificationCompat.NotificationCompatApi19Impl, android.support.p009v4.app.NotificationCompat.NotificationCompatApi16Impl, android.support.p009v4.app.NotificationCompat.NotificationCompatApi20Impl, android.support.p009v4.app.NotificationCompat.NotificationCompatImpl, android.support.p009v4.app.NotificationCompat.NotificationCompatBaseImpl
        public Notification build(Builder builder, BuilderExtender builderExtender) {
    ...
    static class NotificationCompatApi24Impl extends NotificationCompatApi21Impl {
        ...
        @Override // android.support.p009v4.app.NotificationCompat.NotificationCompatApi19Impl, android.support.p009v4.app.NotificationCompat.NotificationCompatApi16Impl, android.support.p009v4.app.NotificationCompat.NotificationCompatApi21Impl, android.support.p009v4.app.NotificationCompat.NotificationCompatApi20Impl, android.support.p009v4.app.NotificationCompat.NotificationCompatImpl, android.support.p009v4.app.NotificationCompat.NotificationCompatBaseImpl
        public Notification build(Builder builder, BuilderExtender builderExtender) {
        ...
        @Override // android.support.p009v4.app.NotificationCompat.NotificationCompatApi16Impl, android.support.p009v4.app.NotificationCompat.NotificationCompatApi20Impl, android.support.p009v4.app.NotificationCompat.NotificationCompatImpl, android.support.p009v4.app.NotificationCompat.NotificationCompatBaseImpl
        public Action[] getActionsFromParcelableArrayList(ArrayList<Parcelable> arrayList) {
    ...
    static class NotificationCompatApi26Impl extends NotificationCompatApi24Impl {
        ...
        @Override // android.support.p009v4.app.NotificationCompat.NotificationCompatApi19Impl, android.support.p009v4.app.NotificationCompat.NotificationCompatApi16Impl, android.support.p009v4.app.NotificationCompat.NotificationCompatApi21Impl, android.support.p009v4.app.NotificationCompat.NotificationCompatApi20Impl, android.support.p009v4.app.NotificationCompat.NotificationCompatImpl, android.support.p009v4.app.NotificationCompat.NotificationCompatBaseImpl, android.support.p009v4.app.NotificationCompat.NotificationCompatApi24Impl
        public Notification build(Builder builder, BuilderExtender builderExtender) {
    ...
    static class NotificationCompatBaseImpl implements NotificationCompatImpl {
        ...
        @Override // android.support.p009v4.app.NotificationCompat.NotificationCompatImpl
        public Notification build(Builder builder, BuilderExtender builderExtender) {
    ...
    public static abstract class Style {
        ...
        private int calculateTopPadding() {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0009b.f19g);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0009b.f20h);
        ...
        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0011d.f44s, 8);
            remoteViews.setViewVisibility(C0011d.f42q, 8);
            remoteViews.setViewVisibility(C0011d.f41p, 8);
        }
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r17, int r18, boolean r19) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p009v4.app.NotificationCompat.Style.applyStandardTemplate(boolean, int, boolean):android.widget.RemoteViews");
        }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0011d.f38m, 0, calculateTopPadding(), 0, 0);
            }
        }
    ...
    static {
        int i = Build.VERSION.SDK_INT;
        IMPL = i >= 26 ? new NotificationCompatApi26Impl() : i >= 24 ? new NotificationCompatApi24Impl() : i >= 21 ? new NotificationCompatApi21Impl() : i >= 20 ? new NotificationCompatApi20Impl() : i >= 19 ? new NotificationCompatApi19Impl() : i >= 16 ? new NotificationCompatApi16Impl() : new NotificationCompatBaseImpl();
    }
