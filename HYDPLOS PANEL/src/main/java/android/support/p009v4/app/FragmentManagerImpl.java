...
import android.support.p009v4.util.ArraySet;
import android.support.p009v4.util.DebugUtils;
import android.support.p009v4.util.LogWriter;
...
public final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    Runnable mExecCommit = new Runnable() {
        /* class android.support.p009v4.app.FragmentManagerImpl.RunnableC02781 */
    ...
    public static class AnimateOnHWLayerIfNeededListener extends AnimationListenerWrapper {
        ...
        @Override // android.support.p009v4.app.FragmentManagerImpl.AnimationListenerWrapper
        public void onAnimationEnd(Animation animation) {
            if (ViewCompat.isAttachedToWindow(this.mView) || Build.VERSION.SDK_INT >= 24) {
                this.mView.post(new Runnable() {
                    /* class android.support.p009v4.app.FragmentManagerImpl.AnimateOnHWLayerIfNeededListener.RunnableC02821 */
    ...
    private class PopBackStackState implements OpGenerator {
        ...
        @Override // android.support.p009v4.app.FragmentManagerImpl.OpGenerator
    ...
    public static class StartEnterTransitionListener implements Fragment.OnStartEnterTransitionListener {
        ...
        @Override // android.support.p009v4.app.Fragment.OnStartEnterTransitionListener
    ...
    private void animateRemoveFragment(final Fragment fragment, AnimationOrAnimator animationOrAnimator, int i) {
        ...
        if (animation != null) {
            ...
            animation.setAnimationListener(new AnimationListenerWrapper(getAnimationListener(animation)) {
                /* class android.support.p009v4.app.FragmentManagerImpl.C02792 */
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            /* class android.support.p009v4.app.FragmentManagerImpl.C02803 */
    ...
    @Override // android.support.p009v4.app.FragmentManager
            ...
            if (loadAnimation == null || (animator = loadAnimation.animator) == null) {
                ...
                if (!fragment.mHidden) {
                    ...
                    loadAnimation.animator.addListener(new AnimatorListenerAdapter() {
                        /* class android.support.p009v4.app.FragmentManagerImpl.C02814 */
    ...
    public void doPendingDeferredStart() {
        ...
        if (this.mHavePendingDeferredStart) {
            ...
            for (int i = 0; i < this.mActive.size(); i++) {
                Fragment valueAt = this.mActive.valueAt(i);
                if (!(valueAt == null || (loaderManagerImpl = valueAt.mLoaderManager) == null)) {
            ...
            if (this.mActive != null) {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    ...
                    if (valueAt != null && ((valueAt.mRemoving || valueAt.mDetached) && !valueAt.mIsNewlyAdded)) {
                        ...
                        LoaderManagerImpl loaderManagerImpl2 = valueAt.mLoaderManager;
                        if (loaderManagerImpl2 != null) {
                            z2 |= loaderManagerImpl2.hasRunningLoaders();
                        }
                    }
                }
                if (!z2) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:41:0x0075, code lost:
        if (r0 != 4) goto L_0x0438;
     */
    /* JADX WARNING: Removed duplicated region for block: B:126:0x0290  */
    /* JADX WARNING: Removed duplicated region for block: B:128:0x0294  */
    ...
    public void moveToState(android.support.p009v4.app.Fragment r18, int r19, int r20, int r21, boolean r22) {
        /*
            ...
            if (fragmentManagerState.mActive != null) {
                ...
                if (fragmentManagerState.mAdded != null) {
                    ...
                    while (true) {
                        ...
                        if (DEBUG) {
                            Log.v(TAG, "restoreAllState: added #" + i6 + ": " + fragment4);
                        }
