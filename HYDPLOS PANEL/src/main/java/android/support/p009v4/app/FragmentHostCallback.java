...
public abstract class FragmentHostCallback<E> extends FragmentContainer {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x0021, code lost:
        if (r1.mStarted == false) goto L_0x000c;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void doLoaderStart() {
        /*
            r3 = this;
            boolean r0 = r3.mLoadersStarted
            if (r0 == 0) goto L_0x0005
            return
        L_0x0005:
            r0 = 1
            r3.mLoadersStarted = r0
            android.support.v4.app.LoaderManagerImpl r1 = r3.mLoaderManager
            if (r1 == 0) goto L_0x0010
        L_0x000c:
            r1.doStart()
            goto L_0x0024
        L_0x0010:
            boolean r1 = r3.mCheckedForLoaderManager
            if (r1 != 0) goto L_0x0024
            r1 = 0
            java.lang.String r2 = "(root)"
            android.support.v4.app.LoaderManagerImpl r1 = r3.getLoaderManager(r2, r0, r1)
            r3.mLoaderManager = r1
            if (r1 == 0) goto L_0x0024
            boolean r2 = r1.mStarted
            if (r2 != 0) goto L_0x0024
            goto L_0x000c
        L_0x0024:
            r3.mCheckedForLoaderManager = r0
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p009v4.app.FragmentHostCallback.doLoaderStart():void");
    }
