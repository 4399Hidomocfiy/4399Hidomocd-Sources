...
public final class NotificationManagerCompat {
    ...
    public static class CancelTask implements Task {
        ...
        @Override // android.support.p009v4.app.NotificationManagerCompat.Task
        public void send(INotificationSideChannel iNotificationSideChannel) {
            if (this.all) {
                iNotificationSideChannel.cancelAll(this.packageName);
            } else {
                iNotificationSideChannel.cancel(this.packageName, this.f1001id, this.tag);
            }
        }

        public String toString() {
            return "CancelTask[" + "packageName:" + this.packageName + ", id:" + this.f1001id + ", tag:" + this.tag + ", all:" + this.all + "]";
        }
    }
    ...
    public static class NotifyTask implements Task {
        ...
        @Override // android.support.p009v4.app.NotificationManagerCompat.Task
        public void send(INotificationSideChannel iNotificationSideChannel) {
            iNotificationSideChannel.notify(this.packageName, this.f1002id, this.tag, this.notif);
        }

        public String toString() {
            return "NotifyTask[" + "packageName:" + this.packageName + ", id:" + this.f1002id + ", tag:" + this.tag + "]";
        }
    }
