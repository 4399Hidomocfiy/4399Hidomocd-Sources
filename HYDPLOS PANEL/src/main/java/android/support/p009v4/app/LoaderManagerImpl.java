...
public class LoaderManagerImpl extends LoaderManager {
    ...
    public final class LoaderInfo implements Loader.OnLoadCompleteListener<Object>, Loader.OnLoadCanceledListener<Object> {
        ...
        @Override // android.support.p009v4.content.Loader.OnLoadCanceledListener
        ...
        @Override // android.support.p009v4.content.Loader.OnLoadCompleteListener
    ...
    @Override // android.support.p009v4.app.LoaderManager
    ...
    public <D> Loader<D> getLoader(int i) {
        if (!this.mCreatingLoader) {
            ...
            return loaderInfo2 != null ? (Loader<D>) loaderInfo2.mLoader : (Loader<D>) loaderInfo.mLoader;
        }
        throw new IllegalStateException("Called while creating a loader");
    }
    ...
    public <D> Loader<D> restartLoader(int i, Bundle bundle, LoaderManager.LoaderCallbacks<D> loaderCallbacks) {
        ...
        if (!this.mCreatingLoader) {
            ...
            if (loaderInfo != null) {
                ...
                if (loaderInfo2 != null) {
                    if (loaderInfo.mHaveData) {
                        ...
                        createAndInstallLoader = createLoader(i, bundle, loaderCallbacks);
                        loaderInfo.mPendingLoader = createAndInstallLoader;
                        return (Loader<D>) createAndInstallLoader.mLoader;
                    }
                } else if (DEBUG) {
            ...
            createAndInstallLoader = createAndInstallLoader(i, bundle, loaderCallbacks);
            return (Loader<D>) createAndInstallLoader.mLoader;
        }
        throw new IllegalStateException("Called while creating a loader");
    }
