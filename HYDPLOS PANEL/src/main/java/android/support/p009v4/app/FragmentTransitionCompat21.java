...
public class FragmentTransitionCompat21 {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: java.util.ArrayList<android.view.View> */
    ...
    public static void scheduleHideFragmentView(Object obj, final View view, final ArrayList<View> arrayList) {
        ((Transition) obj).addListener(new Transition.TransitionListener() {
            /* class android.support.p009v4.app.FragmentTransitionCompat21.C02912 */
    ...
    public static void scheduleNameReset(ViewGroup viewGroup, final ArrayList<View> arrayList, final Map<String, String> map) {
        OneShotPreDrawListener.add(viewGroup, new Runnable() {
            /* class android.support.p009v4.app.FragmentTransitionCompat21.RunnableC02967 */
    ...
    public static void scheduleRemoveTargets(Object obj, final Object obj2, final ArrayList<View> arrayList, final Object obj3, final ArrayList<View> arrayList2, final Object obj4, final ArrayList<View> arrayList3) {
        ((Transition) obj).addListener(new Transition.TransitionListener() {
            /* class android.support.p009v4.app.FragmentTransitionCompat21.C02945 */
    ...
    public static void setEpicenter(Object obj, final Rect rect) {
        if (obj != null) {
            ((Transition) obj).setEpicenterCallback(new Transition.EpicenterCallback() {
                /* class android.support.p009v4.app.FragmentTransitionCompat21.C02956 */
    ...
    public static void setEpicenter(Object obj, View view) {
        if (view != null) {
            ...
            ((Transition) obj).setEpicenterCallback(new Transition.EpicenterCallback() {
                /* class android.support.p009v4.app.FragmentTransitionCompat21.C02901 */
    ...
    public static void setNameOverridesOrdered(View view, final ArrayList<View> arrayList, final Map<String, String> map) {
        OneShotPreDrawListener.add(view, new Runnable() {
            /* class android.support.p009v4.app.FragmentTransitionCompat21.RunnableC02934 */
    ...
    public static void setNameOverridesReordered(View view, final ArrayList<View> arrayList, final ArrayList<View> arrayList2, final ArrayList<String> arrayList3, Map<String, String> map) {
        ...
        OneShotPreDrawListener.add(view, new Runnable() {
            /* class android.support.p009v4.app.FragmentTransitionCompat21.RunnableC02923 */
