...
public final class ViewPropertyAnimatorCompat {
    ...
    private void setListenerInternal(final View view, final ViewPropertyAnimatorListener viewPropertyAnimatorListener) {
        if (viewPropertyAnimatorListener != null) {
            view.animate().setListener(new AnimatorListenerAdapter() {
                /* class android.support.p009v4.view.ViewPropertyAnimatorCompat.C04121 */
        ...
        if (view != null && Build.VERSION.SDK_INT >= 19) {
            ...
            if (viewPropertyAnimatorUpdateListener != null) {
                r1 = new ValueAnimator.AnimatorUpdateListener() {
                    /* class android.support.p009v4.view.ViewPropertyAnimatorCompat.C04132 */
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat mo4388x(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().x(f);
        }
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat mo4390y(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().y(f);
        }
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat mo4392z(float f) {
        View view = this.mView.get();
        if (view != null && Build.VERSION.SDK_INT >= 21) {
            view.animate().z(f);
        }
