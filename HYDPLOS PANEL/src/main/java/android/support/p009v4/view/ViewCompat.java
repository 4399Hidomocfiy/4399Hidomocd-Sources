...
import android.support.p009v4.view.accessibility.AccessibilityNodeProviderCompat;
...
public class ViewCompat {
    ...
    static class ViewCompatApi15Impl extends ViewCompatBaseImpl {
        ...
        @Override // android.support.p009v4.view.ViewCompat.ViewCompatBaseImpl
    ...
    static class ViewCompatApi19Impl extends ViewCompatApi18Impl {
        ...
        @Override // android.support.p009v4.view.ViewCompat.ViewCompatApi16Impl, android.support.p009v4.view.ViewCompat.ViewCompatBaseImpl
        public void setImportantForAccessibility(View view, int i) {
            view.setImportantForAccessibility(i);
        }
    }
        ...
        public void setOnApplyWindowInsetsListener(View view, final OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
            if (onApplyWindowInsetsListener == null) {
                ...
                view.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() {
                    /* class android.support.p009v4.view.ViewCompat.ViewCompatApi21Impl.View$OnApplyWindowInsetsListenerC04061 */
    ...
    static class ViewCompatApi23Impl extends ViewCompatApi21Impl {
        ...
        @Override // android.support.p009v4.view.ViewCompat.ViewCompatBaseImpl, android.support.p009v4.view.ViewCompat.ViewCompatApi21Impl
        public void offsetLeftAndRight(View view, int i) {
    ...
    static {
        ...
        IMPL = i >= 26 ? new ViewCompatApi26Impl() : i >= 24 ? new ViewCompatApi24Impl() : i >= 23 ? new ViewCompatApi23Impl() : i >= 21 ? new ViewCompatApi21Impl() : i >= 19 ? new ViewCompatApi19Impl() : i >= 18 ? new ViewCompatApi18Impl() : i >= 17 ? new ViewCompatApi17Impl() : i >= 16 ? new ViewCompatApi16Impl() : i >= 15 ? new ViewCompatApi15Impl() : new ViewCompatBaseImpl();
    }
