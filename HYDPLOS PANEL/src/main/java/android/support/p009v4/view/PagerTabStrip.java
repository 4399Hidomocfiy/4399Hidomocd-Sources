...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public PagerTabStrip(Context context, AttributeSet attributeSet) {
        ...
        this.mPrevText.setOnClickListener(new View.OnClickListener() {
            /* class android.support.p009v4.view.PagerTabStrip.View$OnClickListenerC04041 */
        ...
        this.mNextText.setOnClickListener(new View.OnClickListener() {
            /* class android.support.p009v4.view.PagerTabStrip.View$OnClickListenerC04052 */
    ...
    @Override // android.support.p009v4.view.PagerTitleStrip
