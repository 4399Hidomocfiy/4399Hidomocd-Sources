...
import android.support.p012v7.widget.AdapterHelper;
import android.support.p012v7.widget.ChildHelper;
import android.support.p012v7.widget.GapWorker;
import android.support.p012v7.widget.ViewBoundsCheck;
import android.support.p012v7.widget.ViewInfoStore;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    static final Interpolator sQuinticInterpolator = new Interpolator() {
        /* class android.support.p012v7.widget.RecyclerView.animationInterpolatorC05343 */
    ...
    private class ItemAnimatorRestoreListener implements ItemAnimator.ItemAnimatorListener {
        ...
        @Override // android.support.p012v7.widget.RecyclerView.ItemAnimator.ItemAnimatorListener
        public void onAnimationFinished(ViewHolder viewHolder) {
    ...
    public static abstract class LayoutManager {
        ...
        public LayoutManager() {
            C05381 r0 = new ViewBoundsCheck.Callback() {
                /* class android.support.p012v7.widget.RecyclerView.LayoutManager.C05381 */

                @Override // android.support.p012v7.widget.ViewBoundsCheck.Callback
            ...
            C05392 r1 = new ViewBoundsCheck.Callback() {
                /* class android.support.p012v7.widget.RecyclerView.LayoutManager.C05392 */
        ...
        public static int getChildMeasureSpec(int r4, int r5, int r6, int r7, boolean r8) {
            ...
            L_0x0031:
                ...
                return r4
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p012v7.widget.RecyclerView.LayoutManager.getChildMeasureSpec(int, int, int, int, boolean):int");
        }
        ...
        public static int getChildMeasureSpec(int r1, int r2, int r3, boolean r4) {
            ...
            L_0x0021:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p012v7.widget.RecyclerView.LayoutManager.getChildMeasureSpec(int, int, int, boolean):int");
        }
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0471R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0471R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0471R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0471R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0471R.styleable.RecyclerView_stackFromEnd, false);
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public boolean performAccessibilityAction(android.support.p012v7.widget.RecyclerView.Recycler r2, android.support.p012v7.widget.RecyclerView.State r3, int r4, android.os.Bundle r5) {
            /*
            // Method dump skipped, instructions count: 121
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p012v7.widget.RecyclerView.LayoutManager.performAccessibilityAction(android.support.v7.widget.RecyclerView$Recycler, android.support.v7.widget.RecyclerView$State, int, android.os.Bundle):boolean");
        }
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(android.view.View r7, int r8) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p012v7.widget.RecyclerView.Recycler.bindViewToPosition(android.view.View, int):void");
        }
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public android.support.p012v7.widget.RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int r17, boolean r18, long r19) {
            /*
            // Method dump skipped, instructions count: 617
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p012v7.widget.RecyclerView.Recycler.tryGetViewHolderForPositionByDeadline(int, boolean, long):android.support.v7.widget.RecyclerView$ViewHolder");
        }
    ...
    public class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        @Override // android.support.p012v7.widget.RecyclerView.AdapterDataObserver
        public void onChanged() {
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() {
            /* class android.support.p012v7.widget.RecyclerView.SavedState.C05401 */
    ...
    public class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p012v7.widget.RecyclerView.ViewFlinger.run():void");
        }
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mUpdateChildViewsRunnable = new Runnable() {
            /* class android.support.p012v7.widget.RecyclerView.RunnableC05321 */
            ...
            public void run() {
                ...
                if (recyclerView.mFirstLayoutComplete && !recyclerView.isLayoutRequested()) {
                    ...
                    if (!recyclerView2.mIsAttached) {
                        ...
                        recyclerView2.mLayoutRequestEaten = true;
                    } else {
        ...
        this.mItemAnimatorRunner = new Runnable() {
            /* class android.support.p012v7.widget.RecyclerView.RunnableC05332 */
        ...
        this.mViewInfoProcessCallback = new ViewInfoStore.ProcessCallback() {
            /* class android.support.p012v7.widget.RecyclerView.C05354 */

            @Override // android.support.p012v7.widget.ViewInfoStore.ProcessCallback
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0471R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes2.getString(C0471R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes2.getInt(C0471R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            boolean z2 = obtainStyledAttributes2.getBoolean(C0471R.styleable.RecyclerView_fastScrollEnabled, false);
            this.mEnableFastScroller = z2;
            if (z2) {
                initFastScroller((StateListDrawable) obtainStyledAttributes2.getDrawable(C0471R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes2.getDrawable(C0471R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes2.getDrawable(C0471R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes2.getDrawable(C0471R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new ChildHelper.Callback() {
            /* class android.support.p012v7.widget.RecyclerView.C05365 */

            @Override // android.support.p012v7.widget.ChildHelper.Callback
            public void addView(View view, int i) {
    ...
    private void pullGlows(float r7, float r8, float r9, float r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p012v7.widget.RecyclerView.pullGlows(float, float, float, float):void");
    }
    ...
    @Override // android.support.p009v4.view.ScrollingView
    ...
    @Override // android.support.p009v4.view.NestedScrollingChild2
    ...
    public android.view.View findContainingItemView(android.view.View r3) {
        ...
        L_0x0014:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p012v7.widget.RecyclerView.findContainingItemView(android.view.View):android.view.View");
    }
    ...
    public void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback() {
            /* class android.support.p012v7.widget.RecyclerView.C05376 */
            ...
            @Override // android.support.p012v7.widget.AdapterHelper.Callback
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0471R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0471R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0471R.dimen.fastscroll_margin));
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (this.mScrollState != 1) {
                if (!canScrollHorizontally || Math.abs(i6) <= (i2 = this.mTouchSlop)) {
                    z = false;
                } else {
                    i6 = i6 > 0 ? i6 - i2 : i6 + i2;
                    z = true;
                }
                if (canScrollVertically && Math.abs(i7) > (i = this.mTouchSlop)) {
                    i7 = i7 > 0 ? i7 - i : i7 + i;
                    z = true;
                }
                if (z) {
            ...
            if (this.mScrollState == 1) {
                ...
                if (scrollByInternal(canScrollHorizontally ? i6 : 0, canScrollVertically ? i7 : 0, obtain)) {
                    getParent().requestDisallowInterceptTouchEvent(true);
                }
