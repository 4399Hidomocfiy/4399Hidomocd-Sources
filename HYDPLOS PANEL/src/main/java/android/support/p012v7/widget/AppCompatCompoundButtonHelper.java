...
import android.support.p009v4.widget.CompoundButtonCompat;
...
public class AppCompatCompoundButtonHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        int resourceId;
        TypedArray obtainStyledAttributes = this.mView.getContext().obtainStyledAttributes(attributeSet, C0467R.styleable.CompoundButton, i, 0);
        try {
            int i2 = C0467R.styleable.CompoundButton_android_button;
            ...
            int i3 = C0467R.styleable.CompoundButton_buttonTint;
            if (obtainStyledAttributes.hasValue(i3)) {
                CompoundButtonCompat.setButtonTintList(this.mView, obtainStyledAttributes.getColorStateList(i3));
            }
            int i4 = C0467R.styleable.CompoundButton_buttonTintMode;
