...
public class ShareActionProvider extends ActionProvider {
    ...
    public class ShareActivityChooserModelPolicy implements ActivityChooserModel.OnChooseActivityListener {
        ...
        @Override // android.support.p012v7.widget.ActivityChooserModel.OnChooseActivityListener
    ...
    public View onCreateActionView() {
        ...
        this.mContext.getTheme().resolveAttribute(C0467R.attr.actionModeShareDrawable, typedValue, true);
        ...
        activityChooserView.setDefaultActionButtonContentDescription(C0467R.string.abc_shareactionprovider_share_with_application);
        activityChooserView.setExpandActivityOverflowButtonContentDescription(C0467R.string.abc_shareactionprovider_share_with);
    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        ...
        if (min < activityCount) {
            SubMenu addSubMenu = subMenu.addSubMenu(0, min, min, this.mContext.getString(C0467R.string.abc_activity_chooser_view_see_all));
