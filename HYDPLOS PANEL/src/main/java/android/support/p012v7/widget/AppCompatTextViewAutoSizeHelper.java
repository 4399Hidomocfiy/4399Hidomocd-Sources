...
public class AppCompatTextViewAutoSizeHelper {
    ...
    private boolean suggestedSizeFitsInSpace(int i, RectF rectF) {
        ...
        StaticLayout createStaticLayoutForMeasuring = i2 >= 23 ? createStaticLayoutForMeasuring(text, alignment, Math.round(rectF.right), maxLines) : createStaticLayoutForMeasuringPre23(text, alignment, Math.round(rectF.right));
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        int resourceId;
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(attributeSet, C0467R.styleable.AppCompatTextView, i, 0);
        int i2 = C0467R.styleable.AppCompatTextView_autoSizeTextType;
        if (obtainStyledAttributes.hasValue(i2)) {
            this.mAutoSizeTextType = obtainStyledAttributes.getInt(i2, 0);
        }
        int i3 = C0467R.styleable.AppCompatTextView_autoSizeStepGranularity;
        ...
        int i4 = C0467R.styleable.AppCompatTextView_autoSizeMinTextSize;
        ...
        int i5 = C0467R.styleable.AppCompatTextView_autoSizeMaxTextSize;
        ...
        int i6 = C0467R.styleable.AppCompatTextView_autoSizePresetSizes;
