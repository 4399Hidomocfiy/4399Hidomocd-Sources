...
public class LinearSnapHelper extends SnapHelper {
    ...
    private float computeDistancePerChild(RecyclerView.LayoutManager layoutManager, OrientationHelper orientationHelper) {
        ...
        return (view == null || view2 == null || (max = Math.max(orientationHelper.getDecoratedEnd(view), orientationHelper.getDecoratedEnd(view2)) - Math.min(orientationHelper.getDecoratedStart(view), orientationHelper.getDecoratedStart(view2))) == 0) ? INVALID_DISTANCE : (((float) max) * INVALID_DISTANCE) / ((float) ((i2 - i) + 1));
    }
