...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public static class LazySpanLookup {
        ...
        public static class FullSpanItem implements Parcelable {
            public static final Parcelable.Creator<FullSpanItem> CREATOR = new Parcelable.Creator<FullSpanItem>() {
                /* class android.support.p012v7.widget.StaggeredGridLayoutManager.LazySpanLookup.FullSpanItem.C05571 */
    ...
    public static class SavedState implements Parcelable {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() {
            /* class android.support.p012v7.widget.StaggeredGridLayoutManager.SavedState.C05581 */
    ...
    public StaggeredGridLayoutManager(int i, int i2) {
        ...
        this.mCheckForGapsRunnable = new Runnable() {
            /* class android.support.p012v7.widget.StaggeredGridLayoutManager.RunnableC05561 */
    ...
    private void handleUpdate(int r7, int r8, int r9) {
        ...
        L_0x0056:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p012v7.widget.StaggeredGridLayoutManager.handleUpdate(int, int, int):void");
    }
    ...
    private void measureChildWithDecorationsAndMargin(View view, LayoutParams layoutParams, boolean z) {
        ...
        if (layoutParams.mFullSpan) {
            if (this.mOrientation == 1) {
                ...
                measureChildWithDecorationsAndMargin(view, RecyclerView.LayoutManager.getChildMeasureSpec(getWidth(), getWidthMode(), 0, ((ViewGroup.MarginLayoutParams) layoutParams).width, true), this.mFullSizeSpec, z);
                return;
            }
        } else if (this.mOrientation == 1) {
            i2 = RecyclerView.LayoutManager.getChildMeasureSpec(this.mSizePerSpan, getWidthMode(), 0, ((ViewGroup.MarginLayoutParams) layoutParams).width, false);
        } else {
            i2 = RecyclerView.LayoutManager.getChildMeasureSpec(getWidth(), getWidthMode(), 0, ((ViewGroup.MarginLayoutParams) layoutParams).width, true);
            i = RecyclerView.LayoutManager.getChildMeasureSpec(this.mSizePerSpan, getHeightMode(), 0, ((ViewGroup.MarginLayoutParams) layoutParams).height, false);
            measureChildWithDecorationsAndMargin(view, i2, i, z);
        }
        i = RecyclerView.LayoutManager.getChildMeasureSpec(getHeight(), getHeightMode(), 0, ((ViewGroup.MarginLayoutParams) layoutParams).height, true);
        measureChildWithDecorationsAndMargin(view, i2, i, z);
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void onLayoutChildren(android.support.p012v7.widget.RecyclerView.Recycler r9, android.support.p012v7.widget.RecyclerView.State r10, boolean r11) {
        /*
        // Method dump skipped, instructions count: 367
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p012v7.widget.StaggeredGridLayoutManager.onLayoutChildren(android.support.v7.widget.RecyclerView$Recycler, android.support.v7.widget.RecyclerView$State, boolean):void");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void recycle(android.support.p012v7.widget.RecyclerView.Recycler r3, android.support.p012v7.widget.LayoutState r4) {
        /*
            r2 = this;
        ...
        L_0x004d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p012v7.widget.StaggeredGridLayoutManager.recycle(android.support.v7.widget.RecyclerView$Recycler, android.support.v7.widget.LayoutState):void");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void updateLayoutState(int r5, android.support.p012v7.widget.RecyclerView.State r6) {
        /*
        // Method dump skipped, instructions count: 119
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p012v7.widget.StaggeredGridLayoutManager.updateLayoutState(int, android.support.v7.widget.RecyclerView$State):void");
    }
    ...
    @Override // android.support.p012v7.widget.RecyclerView.LayoutManager
    ...
    @Override // android.support.p012v7.widget.RecyclerView.SmoothScroller.ScrollVectorProvider
    ...
    public android.view.View hasGapsToFix() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p012v7.widget.StaggeredGridLayoutManager.hasGapsToFix():android.view.View");
    }
    ...
    public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler recycler, RecyclerView.State state, View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        accessibilityNodeInfoCompat.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(i4, i3, i2, i, z, false));
    }
