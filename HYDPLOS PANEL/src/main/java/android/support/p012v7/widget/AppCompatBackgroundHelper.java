...
public class AppCompatBackgroundHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attributeSet, C0467R.styleable.ViewBackgroundHelper, i, 0);
        try {
            int i2 = C0467R.styleable.ViewBackgroundHelper_android_background;
            ...
            int i3 = C0467R.styleable.ViewBackgroundHelper_backgroundTint;
            if (obtainStyledAttributes.hasValue(i3)) {
                ViewCompat.setBackgroundTintList(this.mView, obtainStyledAttributes.getColorStateList(i3));
            }
            int i4 = C0467R.styleable.ViewBackgroundHelper_backgroundTintMode;
