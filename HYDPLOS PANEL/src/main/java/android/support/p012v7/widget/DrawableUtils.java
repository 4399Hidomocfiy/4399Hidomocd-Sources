...
public class DrawableUtils {
    ...
    public static boolean canSafelyMutateDrawable(Drawable drawable) {
        ...
        } else if (drawable instanceof android.support.p012v7.graphics.drawable.DrawableWrapper) {
            drawable2 = ((android.support.p012v7.graphics.drawable.DrawableWrapper) drawable).getWrappedDrawable();
