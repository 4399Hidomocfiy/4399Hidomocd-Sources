...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0467R.styleable.ActionBar);
        this.mBackground = obtainStyledAttributes.getDrawable(C0467R.styleable.ActionBar_background);
        this.mStackedBackground = obtainStyledAttributes.getDrawable(C0467R.styleable.ActionBar_backgroundStacked);
        this.mHeight = obtainStyledAttributes.getDimensionPixelSize(C0467R.styleable.ActionBar_height, -1);
        boolean z = true;
        if (getId() == C0467R.C0469id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = obtainStyledAttributes.getDrawable(C0467R.styleable.ActionBar_backgroundSplit);
        }
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0467R.C0469id.action_bar);
        this.mContextView = findViewById(C0467R.C0469id.action_context_bar);
    }
    ...
    public void onMeasure(int r4, int r5) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p012v7.widget.ActionBarContainer.onMeasure(int, int):void");
    }
