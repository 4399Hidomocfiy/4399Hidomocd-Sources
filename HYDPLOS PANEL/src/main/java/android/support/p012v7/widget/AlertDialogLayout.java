...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private boolean tryOnMeasure(int i, int i2) {
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0467R.C0469id.topPanel) {
                    view = childAt;
                } else if (id == C0467R.C0469id.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C0467R.C0469id.contentPanel && id != C0467R.C0469id.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p012v7.widget.AlertDialogLayout.onLayout(boolean, int, int, int, int):void");
    }
