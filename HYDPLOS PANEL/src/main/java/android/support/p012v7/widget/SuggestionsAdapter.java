...
import android.support.p009v4.widget.ResourceCursorAdapter;
...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0467R.C0469id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0467R.attr.textColorSearchUrl, typedValue, true);
    ...
    @Override // android.support.p009v4.widget.CursorAdapter
    ...
    @Override // android.support.p009v4.widget.CursorAdapter, android.support.p009v4.widget.CursorFilter.CursorFilterClient
    ...
    @Override // android.support.p009v4.widget.CursorAdapter, android.support.p009v4.widget.ResourceCursorAdapter
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        View newView = super.newView(context, cursor, viewGroup);
        newView.setTag(new ChildViewCache(newView));
        ((ImageView) newView.findViewById(C0467R.C0469id.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
