...
import android.support.p009v4.widget.CursorAdapter;
import android.support.p012v7.appcompat.C0467R;
import android.support.p012v7.view.CollapsibleActionView;
...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() {
            /* class android.support.p012v7.widget.SearchView.SavedState.C05521 */
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0467R.attr.autoCompleteTextViewStyle);
        }

        public SearchAutoComplete(Context context, AttributeSet attributeSet, int i) {
            super(context, attributeSet, i);
            this.mRunShowSoftInputIfNecessary = new Runnable() {
                /* class android.support.p012v7.widget.SearchView.SearchAutoComplete.RunnableC05531 */
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            if (i < 960 || i2 < 720 || configuration.orientation != 2) {
                return i < 600 ? (i < 640 || i2 < 480) ? Constants.IF_ICMPNE : Constants.CHECKCAST : Constants.CHECKCAST;
            }
            return 256;
        }
    ...
    private static class UpdatableTouchDelegate extends TouchDelegate {
        ...
        public boolean onTouchEvent(android.view.MotionEvent r8) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p012v7.widget.SearchView.UpdatableTouchDelegate.onTouchEvent(android.view.MotionEvent):boolean");
        }
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0467R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mUpdateDrawableStateRunnable = new Runnable() {
            /* class android.support.p012v7.widget.SearchView.RunnableC05421 */
        ...
        this.mReleaseCursorRunnable = new Runnable() {
            /* class android.support.p012v7.widget.SearchView.RunnableC05442 */
        ...
        View$OnClickListenerC05475 r1 = new View.OnClickListener() {
            /* class android.support.p012v7.widget.SearchView.View$OnClickListenerC05475 */
        ...
        this.mTextKeyListener = new View.OnKeyListener() {
            /* class android.support.p012v7.widget.SearchView.View$OnKeyListenerC05486 */
        ...
        C05497 r2 = new TextView.OnEditorActionListener() {
            /* class android.support.p012v7.widget.SearchView.C05497 */
        ...
        C05508 r3 = new AdapterView.OnItemClickListener() {
            /* class android.support.p012v7.widget.SearchView.C05508 */
        ...
        C05519 r4 = new AdapterView.OnItemSelectedListener() {
            /* class android.support.p012v7.widget.SearchView.C05519 */
        ...
        this.mTextWatcher = new TextWatcher() {
            /* class android.support.p012v7.widget.SearchView.C054310 */
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0467R.styleable.SearchView, i, 0);
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(C0467R.styleable.SearchView_layout, C0467R.layout.abc_search_view), (ViewGroup) this, true);
        SearchAutoComplete searchAutoComplete = (SearchAutoComplete) findViewById(C0467R.C0469id.search_src_text);
        this.mSearchSrcTextView = searchAutoComplete;
        searchAutoComplete.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0467R.C0469id.search_edit_frame);
        View findViewById = findViewById(C0467R.C0469id.search_plate);
        this.mSearchPlate = findViewById;
        View findViewById2 = findViewById(C0467R.C0469id.submit_area);
        this.mSubmitArea = findViewById2;
        ImageView imageView = (ImageView) findViewById(C0467R.C0469id.search_button);
        this.mSearchButton = imageView;
        ImageView imageView2 = (ImageView) findViewById(C0467R.C0469id.search_go_btn);
        this.mGoButton = imageView2;
        ImageView imageView3 = (ImageView) findViewById(C0467R.C0469id.search_close_btn);
        this.mCloseButton = imageView3;
        ImageView imageView4 = (ImageView) findViewById(C0467R.C0469id.search_voice_btn);
        this.mVoiceButton = imageView4;
        ImageView imageView5 = (ImageView) findViewById(C0467R.C0469id.search_mag_icon);
        this.mCollapsedIcon = imageView5;
        ViewCompat.setBackground(findViewById, obtainStyledAttributes.getDrawable(C0467R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(findViewById2, obtainStyledAttributes.getDrawable(C0467R.styleable.SearchView_submitBackground));
        int i2 = C0467R.styleable.SearchView_searchIcon;
        imageView.setImageDrawable(obtainStyledAttributes.getDrawable(i2));
        imageView2.setImageDrawable(obtainStyledAttributes.getDrawable(C0467R.styleable.SearchView_goIcon));
        imageView3.setImageDrawable(obtainStyledAttributes.getDrawable(C0467R.styleable.SearchView_closeIcon));
        imageView4.setImageDrawable(obtainStyledAttributes.getDrawable(C0467R.styleable.SearchView_voiceIcon));
        imageView5.setImageDrawable(obtainStyledAttributes.getDrawable(i2));
        this.mSearchHintIcon = obtainStyledAttributes.getDrawable(C0467R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(imageView, getResources().getString(C0467R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = obtainStyledAttributes.getResourceId(C0467R.styleable.SearchView_suggestionRowLayout, C0467R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = obtainStyledAttributes.getResourceId(C0467R.styleable.SearchView_commitIcon, 0);
        ...
        searchAutoComplete.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            /* class android.support.p012v7.widget.SearchView.View$OnFocusChangeListenerC05453 */
        ...
        setIconifiedByDefault(obtainStyledAttributes.getBoolean(C0467R.styleable.SearchView_iconifiedByDefault, true));
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0467R.styleable.SearchView_android_maxWidth, -1);
        if (dimensionPixelSize != -1) {
            setMaxWidth(dimensionPixelSize);
        }
        this.mDefaultQueryHint = obtainStyledAttributes.getText(C0467R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = obtainStyledAttributes.getText(C0467R.styleable.SearchView_queryHint);
        int i3 = obtainStyledAttributes.getInt(C0467R.styleable.SearchView_android_imeOptions, -1);
        if (i3 != -1) {
            setImeOptions(i3);
        }
        int i4 = obtainStyledAttributes.getInt(C0467R.styleable.SearchView_android_inputType, -1);
        if (i4 != -1) {
            setInputType(i4);
        }
        setFocusable(obtainStyledAttributes.getBoolean(C0467R.styleable.SearchView_android_focusable, true));
        ...
        if (findViewById3 != null) {
            findViewById3.addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
                /* class android.support.p012v7.widget.SearchView.View$OnLayoutChangeListenerC05464 */
    ...
    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0467R.dimen.abc_search_view_preferred_height);
    }

    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0467R.dimen.abc_search_view_preferred_width);
    }
    ...
    public void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0467R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(C0467R.dimen.abc_dropdownitem_text_padding_left) : 0;
    ...
    @Override // android.support.p012v7.view.CollapsibleActionView
    ...
    /* access modifiers changed from: protected */
    @Override // android.support.p012v7.widget.LinearLayoutCompat
    ...
    public void onMeasure(int r4, int r5) {
        ...
        L_0x0053:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p012v7.widget.SearchView.onMeasure(int, int):void");
    }
