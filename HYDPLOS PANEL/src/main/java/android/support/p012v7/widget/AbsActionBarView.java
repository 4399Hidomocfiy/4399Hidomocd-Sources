...
public abstract class AbsActionBarView extends ViewGroup {
    ...
    public class VisibilityAnimListener implements ViewPropertyAnimatorListener {
        ...
        @Override // android.support.p009v4.view.ViewPropertyAnimatorListener
    ...
    AbsActionBarView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (!context.getTheme().resolveAttribute(C0467R.attr.actionBarPopupTheme, typedValue, true) || typedValue.resourceId == 0) {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(null, C0467R.styleable.ActionBar, C0467R.attr.actionBarStyle, 0);
        setContentHeight(obtainStyledAttributes.getLayoutDimension(C0467R.styleable.ActionBar_height, 0));
    ...
    public void postShowOverflowMenu() {
        post(new Runnable() {
            /* class android.support.p012v7.widget.AbsActionBarView.RunnableC04911 */
