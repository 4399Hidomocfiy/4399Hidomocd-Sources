...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public class TabView extends LinearLayoutCompat {
        ...
        public TabView(android.content.Context r6, android.support.p012v7.app.ActionBar.Tab r7, boolean r8) {
            /*
                r4 = this;
                android.support.p012v7.widget.ScrollingTabContainerView.this = r5
                int r5 = android.support.p012v7.appcompat.C0467R.attr.actionBarTabStyle
                r0 = 0
                r4.<init>(r6, r0, r5)
                r1 = 1
                int[] r1 = new int[r1]
                ...
                r4.BG_ATTRS = r1
                r4.mTab = r7
                android.support.v7.widget.TintTypedArray r5 = android.support.p012v7.widget.TintTypedArray.obtainStyledAttributes(r6, r0, r1, r5, r3)
            ...
            L_0x0031:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p012v7.widget.ScrollingTabContainerView.TabView.<init>(android.support.v7.widget.ScrollingTabContainerView, android.content.Context, android.support.v7.app.ActionBar$Tab, boolean):void");
        }
        ...
        public void update() {
            ...
            if (z) {
                if (this.mTextView == null) {
                    AppCompatTextView appCompatTextView = new AppCompatTextView(getContext(), null, C0467R.attr.actionBarTabTextStyle);
    ...
    private Spinner createSpinner() {
        AppCompatSpinner appCompatSpinner = new AppCompatSpinner(getContext(), null, C0467R.attr.actionDropDownStyle);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), null, C0467R.attr.actionBarTabBarStyle);
    ...
    public void animateToTab(int i) {
        ...
        RunnableC05411 r0 = new Runnable() {
            /* class android.support.p012v7.widget.ScrollingTabContainerView.RunnableC05411 */
