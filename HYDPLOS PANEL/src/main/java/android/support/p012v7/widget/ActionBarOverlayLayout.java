...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = {C0467R.attr.actionBarSize, 16842841};
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mTopAnimatorListener = new AnimatorListenerAdapter() {
            /* class android.support.p012v7.widget.ActionBarOverlayLayout.C04931 */
        ...
        this.mRemoveActionBarHideOffset = new Runnable() {
            /* class android.support.p012v7.widget.ActionBarOverlayLayout.RunnableC04942 */
        ...
        this.mAddActionBarHideOffset = new Runnable() {
            /* class android.support.p012v7.widget.ActionBarOverlayLayout.RunnableC04953 */
    ...
    @Override // android.support.p012v7.widget.DecorContentParent
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0467R.C0469id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0467R.C0469id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0467R.C0469id.action_bar));
        }
    }
