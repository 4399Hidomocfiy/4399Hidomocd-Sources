...
import android.support.p009v4.widget.ListViewAutoScrollHelper;
...
public class DropDownListView extends ListViewCompat {
    ...
    public DropDownListView(Context context, boolean z) {
        super(context, null, C0467R.attr.dropDownListViewStyle);
        this.mHijackFocus = z;
        setCacheColorHint(0);
    }
    ...
    public boolean onForwardedEvent(android.view.MotionEvent r8, int r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p012v7.widget.DropDownListView.onForwardedEvent(android.view.MotionEvent, int):boolean");
    }
    ...
    @Override // android.support.p012v7.widget.ListViewCompat
