...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public static final class DefaultSpanSizeLookup extends SpanSizeLookup {
        @Override // android.support.p012v7.widget.GridLayoutManager.SpanSizeLookup
    ...
    public static abstract class SpanSizeLookup {
        ...
        public int getSpanIndex(int r6, int r7) {
            ...
            L_0x003d:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p012v7.widget.GridLayoutManager.SpanSizeLookup.getSpanIndex(int, int):int");
        }
    ...
    /* access modifiers changed from: package-private */
    @Override // android.support.p012v7.widget.LinearLayoutManager
    ...
    @Override // android.support.p012v7.widget.RecyclerView.LayoutManager, android.support.p012v7.widget.LinearLayoutManager
    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        int i13 = 0;
        int i14 = 0;
        while (i14 < this.mSpanCount && layoutState.hasMore(state) && i12 > 0) {
        ...
        for (int i19 = 0; i19 < i14; i19++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i16) {
                ...
                int spaceForSpanRange = getSpaceForSpanRange(layoutParams.mSpanIndex, layoutParams.mSpanSize);
                if (this.mOrientation == 1) {
                    i10 = RecyclerView.LayoutManager.getChildMeasureSpec(spaceForSpanRange, 1073741824, i21, ((ViewGroup.MarginLayoutParams) layoutParams).width, false);
                    ...
                    i9 = RecyclerView.LayoutManager.getChildMeasureSpec(spaceForSpanRange, 1073741824, i20, ((ViewGroup.MarginLayoutParams) layoutParams).height, false);
                    i10 = makeMeasureSpec;
                }
        ...
        if (this.mOrientation == 1) {
            int i23 = layoutState.mLayoutDirection;
            ...
            int i25 = layoutState.mLayoutDirection;
    ...
    @Override // android.support.p012v7.widget.RecyclerView.LayoutManager, android.support.p012v7.widget.LinearLayoutManager
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public android.view.View onFocusSearchFailed(android.view.View r24, int r25, android.support.p012v7.widget.RecyclerView.Recycler r26, android.support.p012v7.widget.RecyclerView.State r27) {
        /*
        // Method dump skipped, instructions count: 337
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p012v7.widget.GridLayoutManager.onFocusSearchFailed(android.view.View, int, android.support.v7.widget.RecyclerView$Recycler, android.support.v7.widget.RecyclerView$State):android.view.View");
    }
