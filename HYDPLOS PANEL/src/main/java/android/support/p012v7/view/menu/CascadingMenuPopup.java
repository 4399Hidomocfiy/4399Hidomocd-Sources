...
import android.support.p012v7.widget.MenuItemHoverListener;
import android.support.p012v7.widget.MenuPopupWindow;
...
public final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private final View.OnAttachStateChangeListener mAttachStateChangeListener = new View.OnAttachStateChangeListener() {
        /* class android.support.p012v7.view.menu.CascadingMenuPopup.View$OnAttachStateChangeListenerC04842 */
    ...
    private final ViewTreeObserver.OnGlobalLayoutListener mGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
        /* class android.support.p012v7.view.menu.CascadingMenuPopup.ViewTreeObserver$OnGlobalLayoutListenerC04831 */
    ...
    private final MenuItemHoverListener mMenuItemHoverListener = new MenuItemHoverListener() {
        /* class android.support.p012v7.view.menu.CascadingMenuPopup.C04853 */

        @Override // android.support.p012v7.widget.MenuItemHoverListener
        public void onItemHoverEnter(final MenuBuilder menuBuilder, final MenuItem menuItem) {
            ...
            if (i != -1) {
                ...
                CascadingMenuPopup.this.mSubMenuHoverHandler.postAtTime(new Runnable() {
                    /* class android.support.p012v7.view.menu.CascadingMenuPopup.C04853.RunnableC04861 */
    ...
    public CascadingMenuPopup(Context context, View view, int i, int i2, boolean z) {
        ...
        this.mMenuMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0467R.dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(MenuBuilder menuBuilder) {
        ...
        if (cascadingMenuInfo == null && this.mShowTitle && menuBuilder.getHeaderTitle() != null) {
            FrameLayout frameLayout = (FrameLayout) from.inflate(C0467R.layout.abc_popup_menu_header_item_layout, (ViewGroup) listView, false);
    ...
    @Override // android.support.p012v7.view.menu.MenuPopup
