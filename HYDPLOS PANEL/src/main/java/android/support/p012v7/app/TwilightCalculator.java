...
public class TwilightCalculator {
    ...
    /* renamed from: C1 */
    private static final float f1008C1 = 0.0334196f;

    /* renamed from: C2 */
    private static final float f1009C2 = 3.49066E-4f;

    /* renamed from: C3 */
    private static final float f1010C3 = 5.236E-6f;
    public static final int DAY = 0;
    private static final float DEGREES_TO_RADIANS = 0.017453292f;

    /* renamed from: J0 */
    private static final float f1011J0 = 9.0E-4f;
    ...
    public void calculateTwilight(long j, double d, double d2) {
        ...
        double d4 = (-d2) / 360.0d;
        double d5 = (double) (f - f1011J0);
        Double.isNaN(d5);
        double round = (double) (((float) Math.round(d5 - d4)) + f1011J0);
        Double.isNaN(round);
