...
public abstract class AppCompatDelegateImplBase extends AppCompatDelegate {
    ...
    private class ActionBarDrawableToggleImpl implements ActionBarDrawerToggle.Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), (AttributeSet) null, new int[]{C0467R.attr.homeAsUpIndicator});
    ...
    static {
        ...
        if (z && !sInstalledExceptionHandler) {
            ...
            Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
                /* class android.support.p012v7.app.AppCompatDelegateImplBase.C04511 */
    ...
    @Override // android.support.p012v7.app.AppCompatDelegate
