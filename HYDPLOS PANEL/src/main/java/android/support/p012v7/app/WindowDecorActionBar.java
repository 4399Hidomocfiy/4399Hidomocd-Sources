...
import android.support.p009v4.view.ViewPropertyAnimatorListener;
import android.support.p009v4.view.ViewPropertyAnimatorListenerAdapter;
import android.support.p009v4.view.ViewPropertyAnimatorUpdateListener;
...
import android.support.p012v7.view.ViewPropertyAnimatorCompatSet;
...
import android.support.p012v7.widget.ActionBarContainer;
import android.support.p012v7.widget.ActionBarContextView;
import android.support.p012v7.widget.ActionBarOverlayLayout;
import android.support.p012v7.widget.DecorToolbar;
import android.support.p012v7.widget.ScrollingTabContainerView;
...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new ViewPropertyAnimatorListenerAdapter() {
        /* class android.support.p012v7.app.WindowDecorActionBar.C04641 */
    ...
    final ViewPropertyAnimatorListener mShowListener = new ViewPropertyAnimatorListenerAdapter() {
        /* class android.support.p012v7.app.WindowDecorActionBar.C04652 */
    ...
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new ViewPropertyAnimatorUpdateListener() {
        /* class android.support.p012v7.app.WindowDecorActionBar.C04663 */

        @Override // android.support.p009v4.view.ViewPropertyAnimatorUpdateListener
    ...
    public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
        ...
        @Override // android.support.p012v7.view.ActionMode
        public void finish() {
            WindowDecorActionBar windowDecorActionBar = WindowDecorActionBar.this;
    ...
    public class TabImpl extends ActionBar.Tab {
        ...
        @Override // android.support.p012v7.app.ActionBar.Tab
    ...
    private void init(View view) {
        ActionBarOverlayLayout actionBarOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0467R.C0469id.decor_content_parent);
        this.mOverlayLayout = actionBarOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0467R.C0469id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0467R.C0469id.action_context_bar);
        ActionBarContainer actionBarContainer = (ActionBarContainer) view.findViewById(C0467R.C0469id.action_bar_container);
        ...
        if (obtainStyledAttributes.getBoolean(C0467R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0467R.styleable.ActionBar_elevation, 0);
    ...
    @Override // android.support.p012v7.widget.ActionBarOverlayLayout.ActionBarVisibilityCallback
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0467R.attr.actionBarWidgetTheme, typedValue, true);
