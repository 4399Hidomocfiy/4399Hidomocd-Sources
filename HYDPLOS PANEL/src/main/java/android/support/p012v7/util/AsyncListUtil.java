...
public class AsyncListUtil<T> {
    ...
    public AsyncListUtil(Class<T> cls, int i, DataCallback<T> dataCallback, ViewCallback viewCallback) {
        C04741 r0 = new ThreadUtil.MainThreadCallback<T>() {
            /* class android.support.p012v7.util.AsyncListUtil.C04741 */
        ...
        C04752 r1 = new ThreadUtil.BackgroundCallback<T>() {
            /* class android.support.p012v7.util.AsyncListUtil.C04752 */
