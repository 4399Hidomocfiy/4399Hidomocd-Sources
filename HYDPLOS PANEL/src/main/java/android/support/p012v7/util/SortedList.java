...
public class SortedList<T> {
    ...
    public static class BatchedCallback<T2> extends Callback<T2> {
        ...
        @Override // android.support.p012v7.util.SortedList.Callback, java.util.Comparator
    ...
    public T get(int i) {
        ...
        return (tArr == null || i < (i2 = this.mMergedSize)) ? this.mData[i] : tArr[(i - i2) + this.mOldDataStart];
    }
