...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(C0072R.dimen.design_bottom_navigation_text_size);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(C0072R.dimen.design_bottom_navigation_active_text_size);
        this.mDefaultMargin = resources.getDimensionPixelSize(C0072R.dimen.design_bottom_navigation_margin);
        ...
        LayoutInflater.from(context).inflate(C0072R.layout.design_bottom_navigation_item, (ViewGroup) this, true);
        setBackgroundResource(C0072R.C0073drawable.design_bottom_navigation_item_background);
        this.mIcon = (ImageView) findViewById(C0072R.C0074id.icon);
        this.mSmallLabel = (TextView) findViewById(C0072R.C0074id.smallLabel);
        this.mLargeLabel = (TextView) findViewById(C0072R.C0074id.largeLabel);
    }
