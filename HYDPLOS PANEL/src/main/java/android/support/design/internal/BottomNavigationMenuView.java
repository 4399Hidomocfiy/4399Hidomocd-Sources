...
import android.support.transition.C0207e0;
...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    public BottomNavigationMenuView(Context context, AttributeSet attributeSet) {
        ...
        this.mInactiveItemMaxWidth = resources.getDimensionPixelSize(C0072R.dimen.design_bottom_navigation_item_max_width);
        this.mInactiveItemMinWidth = resources.getDimensionPixelSize(C0072R.dimen.design_bottom_navigation_item_min_width);
        this.mActiveItemMaxWidth = resources.getDimensionPixelSize(C0072R.dimen.design_bottom_navigation_active_item_max_width);
        this.mItemHeight = resources.getDimensionPixelSize(C0072R.dimen.design_bottom_navigation_height);
        AutoTransition autoTransition = new AutoTransition();
        this.mSet = autoTransition;
        autoTransition.mo1498r(0);
        autoTransition.mo1496p(ACTIVE_ANIMATION_DURATION_MS);
        autoTransition.setInterpolator(new FastOutSlowInInterpolator());
        autoTransition.mo1490j(new TextScale());
        this.mOnClickListener = new View.OnClickListener() {
            /* class android.support.design.internal.BottomNavigationMenuView.View$OnClickListenerC00751 */
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.mShiftingMode) {
            ...
            while (i6 < childCount) {
                ...
                iArr[i6] = i6 == this.mSelectedItemPosition ? min : min2;
                if (i5 > 0) {
                    iArr[i6] = iArr[i6] + 1;
                    i5--;
                }
