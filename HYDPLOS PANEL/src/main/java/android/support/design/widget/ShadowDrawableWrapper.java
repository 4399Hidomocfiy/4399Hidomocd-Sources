...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f, float f2, float f3) {
        super(drawable);
        this.mShadowStartColor = ContextCompat.getColor(context, C0072R.color.design_fab_shadow_start_color);
        this.mShadowMiddleColor = ContextCompat.getColor(context, C0072R.color.design_fab_shadow_mid_color);
        this.mShadowEndColor = ContextCompat.getColor(context, C0072R.color.design_fab_shadow_end_color);
    ...
    private void buildComponents(Rect rect) {
        ...
        this.mContentBounds.set(((float) rect.left) + f, ((float) rect.top) + f2, ((float) rect.right) - f, ((float) rect.bottom) - f2);
    ...
    private void buildShadowCorners() {
        ...
        if (f3 > 0.0f) {
            ...
            this.mCornerShadowPaint.setShader(new RadialGradient(0.0f, 0.0f, f3, new int[]{0, this.mShadowStartColor, this.mShadowMiddleColor, this.mShadowEndColor}, new float[]{0.0f, f4, ((SHADOW_BOTTOM_SCALE - f4) / 2.0f) + f4, 1.0f}, Shader.TileMode.CLAMP));
        }
