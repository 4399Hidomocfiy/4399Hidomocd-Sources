...
public class C0142b {
    /* renamed from: a */
    private static Interpolator m391a(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser) {
        Interpolator eVar;
                ...
                if (next == 2) {
                    ...
                    if (name.equals("linearInterpolator")) {
                        ...
                        if (name.equals("accelerateInterpolator")) {
                            ...
                            eVar = new animationInterpolatorC0147e(context, asAttributeSet, xmlPullParser);
                        } else {
    ...
    /* renamed from: b */
    public static Interpolator m392b(Context context, int i) {
        ...
        if (i == 17563663) {
            ...
            Interpolator a = m391a(context, context.getResources(), context.getTheme(), animation);
            if (animation != null) {
                animation.close();
            }
            return a;
